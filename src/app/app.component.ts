...
export class AppComponent {
  ...
  constructor(private documentService: DocumentService) {
    ...
    // const urls = data.filter((item) =>{
    //   this.filteredURLS.push(item.url)
    // } )
    // console.log(this.filteredURLS);
    // console.log(this.filteredURLS.length)
  }

  onDowloadBatch = () => {
    this.documentService.downloadDocuments();
  };
}
